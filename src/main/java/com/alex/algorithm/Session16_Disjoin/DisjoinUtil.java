...
public class DisjoinUtil {
  ...
  private static Integer[] parent = new Integer[MAX + 5];
  private static Integer[] ranks = new Integer[MAX + 5];
  ...
  public static int countDistinctParent() {
    if (parent == null) {
      return 0;
    }
    final Set<Integer> distinctParents = new HashSet<>(Arrays.asList(parent));
    return distinctParents.size();
  }

  public static Integer[] getRanks() {
    return ranks;
  }
}
